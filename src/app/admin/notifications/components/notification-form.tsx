  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <ScrollArea className="h-[calc(80vh-220px)] pr-6 -mr-6">
        ...
        {/* Buttons are outside the scrollable area */}
        <div className="flex justify-end space-x-2 pt-4 border-t -mx-6 px-6 mt-4 pb-0">
